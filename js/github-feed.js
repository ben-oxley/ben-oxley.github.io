...
$.fn.githubfeed = function(g, h) {
    var j = '<div class="github-feed row">';
    j += '<div class="gftabs"><div class="gftab aktip col-md-3" data-dip="repos">Repositories</div><div class="gftab col-md-3" data-dip="activ">Activity</div><div class="gftab col-md-3" data-dip="gists">Gists</div></div>';
    j += '<div class="bod">';
    j += '	<div class="feed ben-oxleyrepos" style="display:none"></div>';
    j += '	<div class="feed ben-oxleygists" style="display:none"></div>';
    j += '	<div class="feed ben-oxleyactiv"></div>';
    j += '</div>';
    j += '<div class="foot">';
    j += '	Github Feed <a href="https://github.com/ben-oxley/jQuery-Github-Feed" class="jgf" target="_blank">made with <i class="octicon octicon-heart" style="color:salmon"></i></a>';
    j += '</div>';
    j += '</div>';
    $(this).html(j);
    ibacor_profil(g);
